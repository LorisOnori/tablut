...
public class Heuristic {
	...
	public static double eval(Board brd, Player player) {
		...
		if(brd.kingBetweenTwoBlack() && !(brd.kindPosition == Board.NORD_CENTER_POS || brd.kindPosition == Board.EST_CENTER_POS || brd.kindPosition == Board.SUD_CENTER_POS || brd.kindPosition == Board.OVEST_CENTER_POS)) {
			return MIN;
		}
